...
\begin{frame}
  ...
  \begin{itemize}
    \item While GJKR protects against the key-bias attack that Pedersen DKG does not, it requires an additional network round.
    \item[]
    \item<2-> Ideally, we can have a two-round DKG that is provable in a stand-alone manner.
    \item[]
